...
export default function Writtenexam() {
    ...
    const fetchAppointments = async () => {
        try {
            const response = await axios.get("http://localhost:5000/fetch_written_appointments");
    ...
    const handleAccept = async () => {
        ...
        try {
            await axios.post(`http://localhost:5000/written_appointments/${selectedAppointment.id}/accept`);
            setShowModal(false);
            fetchAppointments();
        } catch (error) {
    ...
    const handleReject = async () => {
        if (!selectedAppointment) return;
        try {
            await axios.post(`http://localhost:5000/written_appointments/${selectedAppointment.id}/reject`);
            setShowModal(false);
            fetchAppointments();
        } catch (error) {
            ...
            <Container fluid className="mt-3 mx-3">
                <div className="row">
                    ...
                    <div className="col-md-8 p-4 shadow-sm" style={{
                        ...
                        <h4 className="text-primary text-center">Written Exam Appointment</h4>
