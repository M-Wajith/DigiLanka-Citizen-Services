...
export default function Dispatchedpassport(){
    const navigate = useNavigate();
        ...
        useEffect(() => {
            ...
            axios
                .get("http://localhost:5000/api/dispatched_passport") // Make sure to use the correct endpoint URL
                .then((response) => {
                           ...
                           <div className="col-md-8 p-4 shadow-sm" style={{ minHeight: "80vh", backgroundColor: "#e9ecef", borderRadius: "10px", width: "79%" }}>
                                    <h4 className="text-primary text-center">Printed Passport Applications</h4>
                                        ...
                                        {passportData.length === 0 ? (
                                            <p className="text-center text-muted">No dispatched applications available.</p>
                                        ) : (
