...
export default function Printednic(){
    ...
    const [loading, setLoading] = useState(null);
        ...
        useEffect(() => {
            fetch("http://localhost:5000/api/printed_nic") // Update with your actual backend URL
    ...
    const handleDispatch = async (old_nic_number) => {
        setLoading(old_nic_number); // Set loading for the clicked button
        try {
            const response = await axios.post(`http://127.0.0.1:5000/api/dispatch_nic/${old_nic_number}`);
                                                ...
                                                <Container fluid className="mt-3 mx-3">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-8 p-4 shadow-sm" style={{ 
                                                            ...
                                                            <h4 className="text-primary text-center">Printed Applications</h4>
                                                            
                                                                {/* ✅ Display message when applications array is empty */}
                                                                {applications.length === 0 ? (
                                                                    <p className="text-center text-muted">No printed nic applications.</p>
                                                                ) : (
                                                                            ...
                                                                            <div className="d-flex justify-content-between align-items-center">
                                                                                ...
                                                                                <div className="d-flex" style={{ minWidth: "200px", justifyContent: "flex-end" }}>
                                                                                    <button className="btn btn-success me-2" 
                                                                                        onClick={() => handleDispatch(app.old_nic_number)}
