...
public class PracticalActivity extends AppCompatActivity {
    ...
    private class SendAppointmentTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                // Change this URL to the Practical API endpoint
                URL url = new URL("http://10.0.2.2:5000/practical_appointments");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                Toast.makeText(PracticalActivity.this, "Appointment request sent successfully!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(PracticalActivity.this, "Failed to send appointment request", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
