...
public class WrittenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("WrittenActivity", "NIC Number: " + nicNumber);
        ...
        timeSlotsRecyclerView = findViewById(R.id.writtentimeSlotsRecyclerView);
    ...
    private void sendAppointmentRequest(String timeSlot) {
        ...
        new SendAppointmentTask(nicNumber, formattedStartTime, formattedEndTime).execute();
    }
    ...
    private class SendAppointmentTask extends AsyncTask<Void, Void, String> {
        ...
        public SendAppointmentTask(String nic, String startTime, String endTime) {
            this.nic = nic;
        ...
        protected String doInBackground(Void... voids) {
            try {
                ...
                URL url = new URL("http://10.0.2.2:5000/written_appointments"); // Updated API endpoint
                ...
                jsonParam.put("nic", nic); // Using NIC number as the title
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                Toast.makeText(WrittenActivity.this, "Appointment request sent successfully!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(WrittenActivity.this, "Failed to send appointment request", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
